...
enum Risk: String, Identifiable, CaseIterable {
  ...
  var description: String {
    switch self {
    case .easy:
      return "Bring the essentials (water, bug spray, sunscreen) and get ready to enjoy a nice stroll. Be sure to log your hike in your fitness app to keep track of your progress. Have your camera ready to capture views and good times!"
    case .moderate:
